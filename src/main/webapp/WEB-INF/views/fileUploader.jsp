		...
		<div class="panel panel-default">
			...
			<div class="jpg-dz" <%--style="text-align: center"--%> >
				...
				<img src="/web-resources/pictures/parser flow.jpg" style="width: 1120px">
					...
					<%--<img src="/web-resources/pictures/parser flow.jpg" style="width: 70px">--%>
					<%--<span><center><img class="media-object" src="/web-resources/pictures/parser flow.jpg" alt="Generic placeholder image" style="width:140px"></center></span>--%>

					<%--View and analyze your CV files online with PDF and DOC Online Reader. Click the button below to get started!--%>
					<%--<div class="media">
						<div class="media-left media-middle">
								<img class="media-object" src="/web-resources/pictures/1.jpg" alt="Generic placeholder image" style="width:80px">
						</div>
						<div class="media-body col-xs-offset-1">
							<h4 class="media-heading" align="left">Paste CV file ...</h4>
						</div>
					</div>--%>
			...
			<div class="panel-body">
				<div>
					...
					<hr>
								<%--	<div class="media-left media-middle">
										<img class="media-object" src="/web-resources/pictures/2.jpg" alt="Generic placeholder image" style="width:80px">
										<div class="col-xs-offset-1">
											<h4 class="media-heading" align="left">UPLOAD CV file ...</h4>
										</div>
									</div>--%>
					<hr>
					<div class="row">
